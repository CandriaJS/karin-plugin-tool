...
export const help = karin.command(/^#?(?:柠糖工具)(?:命令|帮助|菜单|help|说明|功能|指令|使用说明)$/i, async (e: Message) => {
...
export const version = karin.command(/^#?(?:柠糖工具)(?:版本|版本信息|version|versioninfo)$/i, async (e: Message) => {
